...
function selectLetter(l) {
    ...
    if (testing.indexOf(l) != -1) {
        ...
        if (wordShow.indexOf("*") == -1) {
            ...
            disableButton();
            cntCorrect +=1;
            alert("You get the correct answer '" + testing+ "'  . ");
            
            if (cntCorrect == 1 && flagA1 == 0){eval("document.badge1.src=\"http://www.columbia.edu/~zz2220/a4.png\"");alert("Congratulations, you unlock Dora-Brain Badge(Lv.1)!"); flagA1 = 1;}
            if (cntCorrect == 3 && credit >=80 && flagA2 == 0){eval("document.badge1.src=\"http://www.columbia.edu/~zz2220/a2.png\"");alert("Congratulations, you update Dora-Brain Badge to Lv.2!"); flagA2 = 1;}
            if (cntCorrect == 5 && credit >=100 && flagA3 == 0){eval("document.badge1.src=\"http://www.columbia.edu/~zz2220/a5.png\"");alert("Congratulations, you update Dora-Brain Badge to Lv.3!"); flagA3 = 1;}
        ...
        if (wrongCnt == 8) {
            ...
            alert("You missed this word. Try again or simply press PASS button to get another one! Good Luck! ");
            if (flagC1 == 0){eval("document.badge3.src=\"http://www.columbia.edu/~zz2220/c2.png\"");alert("Oops, you unlock Dora-Storm Badge(Lv.1)!"); flagC1 = 1;}
            if (credit <= 0) {
                alert("You ran out your credits! Game will be restarted."); 
                if (credit <= 0 && cntCorrect >= 3 && flagC2 == 0){eval("document.badge3.src=\"http://www.columbia.edu/~zz2220/c1.png\"");alert("Oops, you ungrade Dora-Storm Badge to Lv.2!"); flagC2 = 1;};
...
<%if(session.getAttribute("loginName")!=null){ %>
   ...
   <td><%=servlet.totalNumber %></td>
   <td><%=servlet.generatedGREWord %></td>
   <td><%=servlet.number %></td>
   <td>testing</td>
   </tr>
...
<!-- <p>Your are logged in as <%=session.getAttribute("loginName") %>
    ...
    <p><pre style="font-size:18px"> Hi! <b><%=session.getAttribute("loginName") %></b>,  Welcome to Save Doraemon, he needs you!    <a href=<%=basePath+"pages/Logout.jsp" %>>log out!</a></pre></p>
...
<input type="submit" name="submit" value="Pass" class="" style="background-color:rgb(185,240,229);CURSOR: hand"/></p>     
...
<!-- 
<table class="addButton" width="800">
<br><br><br><br><br><br>
...
<tr>
  ...
  <form action="/view" method="post">        
        <p><input type="submit" name="submit" value="VIEW" class="" style="background-color:rgb(185,240,229);CURSOR: hand"/>
